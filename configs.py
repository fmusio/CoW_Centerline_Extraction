...
do_mask_corrections = False # perform mask corrections or not
...
fixed_dist_angle = False # whether to use fixed distance for angle computation or dynamic distance to segment boundary points (only for major bifurcations BA/ICA)
dist_angle = 1.5 # distance [mm] to sample points around bifurcation for angle computation
nr_pts_angle_average = 3 # number of points to average for angle computation
